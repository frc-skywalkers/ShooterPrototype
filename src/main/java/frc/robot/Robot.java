...
public class Robot extends TimedRobot {
  ...
  private final int leftID = 22;
  private final int rightID = 23;
  ...
  public void robotInit() {
    ...
    leftShooter = new TalonFX(leftID);
    rightShooter = new TalonFX(rightID);
    leftShooter.setInverted(inv);
    rightShooter.setInverted(!inv); 
    SmartDashboard.putNumber("goalSpeed", 0);
  }
